# Alert-Bridge E2E Docker Test Suite

Comprehensive end-to-end testing framework for the alert-bridge system using Docker Compose orchestration and custom mock services.

**Note:** This is the Docker-based E2E test suite. For faster, in-process mock-based tests without Docker, see `test/e2e/`.
